<template>
    <div class="popup fixed inset-0 z-50 bg-black/90 flex items-center justify-center">
        <Toast v-if="showToast" message="Saved Successfully" :is-success="true"/>
                ...
                <div class="flex flex-col mt-4 items-center justify-center">
                    ...
                    <form class="flex flex-col mt-2 w-full" id="todoForm">
                        <div>
                            ...
                            />
                            <span class="flex text-xs text-red-700 h-5 mt-1" id="tdtErr"></span>
                        </div>
                        <div class="inline-flex items-center">
                            <label class="relative flex items-center py-3 rounded-full cursor-pointer" htmlFor="teal">
                                <input type="checkbox"
                                    id="teal"
